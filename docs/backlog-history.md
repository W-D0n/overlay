# Historique du backlog — Overlay Stream

Archive des décisions, investigations et lots terminés auparavant conservés dans `docs/inbox.md`.
Les items encore à traiter vivent uniquement dans [`docs/inbox.md`](inbox.md) ; les clôtures
récentes sont aussi résumées dans [`docs/devlog.md`](devlog.md). Les statuts anciens ci-dessous
conservent leur contexte de l’époque et ne prévalent pas sur le code ou les documents actifs.
...
2026-07-10 — cette entrée était restée obsolète, corrigée en investiguant `docs/backlog-history.md` §Gestion
...
- **Placement fin à l'intérieur d'une couche composite** — le mécanisme lui-même était déjà livré
  ...
  owner (2026-07-10), même schéma que `docs/backlog-history.md` §Gestion des couches. Ce qui manquait
